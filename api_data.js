define({ "api": [
  ...
  },
  {
    ...
    "name": "Step_2",
    "version": "201707.0.1",
    "description": "<img src=\"/img/image1.png\" width=\"700\" alt=\"Alt text\"> <p>Hotel Registration Steps:</p> <ol> <li>Customer selects OTA from list of channels on MA, enters hotel id or username, and password (regcode) and this is passed in a SetupProperty</li> <li>MA sends GetRooms and receives a list of Rooms configured on OTA, customer performs Room mapping of MA Room Types to OTA Room Types.</li> <li>Customer finalizes by performing a full refresh of all data to OTA Done!</li> </ol>",
    "filename": "./build2us.pm",
    "groupTitle": "Getting_Started"
  },
  {
  ...
  },
  {
    ...
    "name": "Step_4",
    "version": "201707.0.1",
    "description": "<p>OUTBOUND rest api calls (json post to api_url) (from MyAllocator to OTA)</p> <img src=\"/img/image4.png\" width=\"700\" alt=\"Alt text\">",
    "filename": "./build2us.pm",
    "groupTitle": "Getting_Started"
  },
  {
  ...
  },
  {
    ...
    "name": "Overview",
    "version": "201707.0.1",
    "description": "<p>This API allows an OTA (travel booking website) to integrate with MyAllocator by implementing a public-facing API receiver in their environment.</p> <p>The API integration may be developed in any language, however, we have provided a PHP SDK library and receiver that you may drop into your PHP environment to speed up integration. The PHP SDK may be found <a href=\"https://github.com/MyAllocator/myallocator-ota-php\">here</a>.</p> <p>Its as simple as:</p> <img src=\"/img/image3.png\" width=\"700\" alt=\"Alt text\">",
    "filename": "./build2us.pm",
    "groupTitle": "Overview"
  },
  {
  ...
  },
  {
        ...
        "Booking": [
          {
            ...
            "optional": false,
            "field": "Customers",
            "description": "<p>Array of customers. Include at least one guest</p>"
          },
          {
            "group": "Booking",
            "type": "String",
          ...
          },
          {
            ...
            "description": "<p>Customer company</p>"
          },
          {
            "group": "Booking",
            "type": "String",
          ...
          },
          {
            ...
            "description": "<p>set true if booking is cancelled</p>"
          },
          {
            "group": "Booking",
            "type": "String",
            "optional": false,
            "field": "OrderDate",
            "description": "<p>(recommended) order created date yyyy-mm-dd</p>"
          },
          {
            "group": "Booking",
            "type": "String",
            "optional": false,
            "field": "OrderTime",
            "description": "<p>(recommended) order created time hh:mm:ss</p>"
          },
          {
            "group": "Booking",
            "type": "String",
            "optional": false,
            "field": "OrderId",
            "description": "<p>ota order reference</p>"
          },
          {
            "group": "Booking",
            "type": "String",
            "optional": false,
            "field": "TotalCurrency",
            "description": "<p>currency for the booking</p>"
          },
          {
            "group": "Booking",
            "type": "String",
            "optional": false,
            "field": "TotalPrice",
            "description": "<p>total price for everything</p>"
          },
          {
            "group": "Booking",
            "type": "String",
            "optional": true,
            "field": "Commission",
            "description": "<p>ota commission amount</p>"
          },
          {
            "group": "Booking",
            "type": "String",
            ...
            "description": "<p>ota commission currency</p>"
          },
          {
            "group": "Booking",
            "type": "String",
            "optional": true,
            "field": "Deposit",
            "description": "<p>any deposit collected by the OTA</p>"
          },
          {
            "group": "Booking",
            "type": "String",
            ...
            "description": "<p>If Deposit is set, this is the currency</p>"
          },
          {
            "group": "Booking",
            "type": "String",
            "optional": true,
            "field": "Balance",
            "description": "<p>If deposit is set, this is the remaining balance</p>"
          },
          {
            "group": "Booking",
            "type": "String",
            ...
            "description": "<p>If balance is set, this is the currency</p>"
          },
          {
            "group": "Booking",
            "type": "Array",
            "optional": false,
            "field": "Rooms",
            "description": "<p>one for each unique stay</p>"
          },
          {
            "group": "Booking",
            "type": "Number",
            "optional": false,
            "field": "Units",
            "description": "<p>number of rooms, or beds for a dormitory</p>"
          },
          {
            "group": "Booking",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "EndDate",
            "description": "<p>ast day of stay (departure date - 1)</p>"
          },
          {
            "group": "Booking",
            "type": "String",
            ...
            "description": "<p>the mapped room identifier on the ota. This field is unique to Build2Us api</p>"
          },
          {
            "group": "Booking",
            "type": "String",
            "optional": false,
            "field": "RoomDesc",
            "description": "<p>a short description of the room</p>"
          },
          {
            "group": "Booking",
            "type": "Number",
            "optional": true,
            "field": "Adults",
            "description": "<p>number of adults staying in room</p>"
          },
          {
            "group": "Booking",
            "type": "Number",
            "optional": true,
            "field": "Children",
            "description": "<p>number of children staying in room</p>"
          },
          {
            "group": "Booking",
            "type": "String",
            "optional": true,
            "field": "Price",
            "description": "<p>total price for the room (for all days)</p>"
          },
          {
            "group": "Booking",
            "type": "Array",
            "optional": false,
            "field": "Payments",
            "description": "<p>Array of payments</p>"
          },
          {
            "group": "Booking",
            "type": "String",
    ...
    "description": "<p><a href=\"https://github.com/MyAllocator/bookingsamples\">More Booking Examples</a></p> <p><strong>IMPORTANT</strong>: The github BookingSamples link above is intended for a PMS Integrating into MyAllocator. As an OTA there are a few key differences in the format.  OTA Bookings should <em>NEVER</em> include RoomTypeIds:[] node, instead pass &quot;ChannelRoomType&quot;:&quot;123&quot;. Do not attempt to pass &quot;channel&quot;, or any field labelled &quot;myallocator_xxxx&quot; (all those will be setup automatically)</p> <p>In the example(s) there are various formats from different OTA's. To complete the BuildToUs certification you must use an example which includes the &quot;DayRates&quot; field(s). Future versions of the BuildToUs will require DayRates to pass validation.</p> <p>implementation suggestions: when testing make sure the MyAllocator test property has &quot;download bookings&quot; enabled or the booking will be saved in a queue and not visible during testing.  To enable login and go to Manage / General / Download new bookings. Default setting is &quot;off/disabled&quot;.  Once enabled please allow 30 minutes for the backend to start processing bookings. Also there may be a normal 1-2 minute period after a GetBookingId response before the booking is visible in the inbox.myallocator.com interface (the bookings are held in a temporary queue on our backend).</p> <p>For testing please use: <em>http://api.myallocator.com/callback/ota/{CID}/v201503/NotifyBooking?ota_property_id={OTA_PID}&amp;booking_id={OTA_ID}&amp;output=json&amp;debug=1</em></p> <p>that url (specifically the &amp;output=json&amp;debug=1 on the URL) will return additional debugging messaging which will provide insight into validation errors.</p>",
    "filename": "./build2us.pm",
    "groupTitle": "SDK_Reference"
  },
  {
  ...
  },
  {
    ...
    "type": "POST",
    "url": "/",
    "title": "GetRatePlans (not currently implemented)",
    "name": "GetRatePlans__not_currently_implemented_",
    "version": "201707.0.1",
    "examples": [
      {
        "title": "Request",
